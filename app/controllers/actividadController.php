...
require_once MAIN_APP_ROUTE . '../models/ActividadesModel.php';
...
class ActividadController extends BaseController
{
    ...
    public function view()
    {
        ...
        // Llamamos a la vista
        $this->render('actividad/viewActividad.php', ["actividad" => $actividades]);
    }
    ...
    public function viewActividad($id)
{
    ...
    public function deleteActividad($id) {
        $actividadObj = new ActividadModel();
        $result = $actividadObj->deleteActividad($id);
        if ($result) {
            $this->redirectTo("actividad/view");
        } else {
