...
class ControlProgresoModel extends BaseModel {
    ...
    public function saveControlProgreso($fechaRealizacion, $peso, $cintura, $cadera, $musloDerecho, $musloIzquierdo, $brazoDerecho, $brazoIzquierdo, $antebrazoDerecho, $antebrazoIzquierdo, $pantorrillaDerecha, $pantorrillaIzquierda, $examenMedico, $observaciones, $fechaExamen, $fkIdUsuario) {
        try {
            $sql = "INSERT INTO $this->table (fechaRealizacion, peso, cintura, cadera, musloDerecho, musloIzquierdo, brazoDerecho, brazoIzquierdo, antebrazoDerecho, antebrazoIzquierdo, pantorrillaDerecha, pantorrillaIzquierda, examenMedico, observaciones, fechaExamen, FkIdUsuario) VALUES (:fechaRealizacion, :peso, :cintura, :cadera, :musloDerecho, :musloIzquierdo, :brazoDerecho, :brazoIzquierdo, :antebrazoDerecho, :antebrazoIzquierdo, :pantorrillaDerecha, :pantorrillaIzquierda, :examenMedico, :observaciones, :fechaExamen, :FkIdUsuario)";
